...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btnAc,btnDel,btnIgual,btn1,btn2,btn3,btn4,btn5,btn6,btn7,btn8,btn9,btnCero,btnCeroo,btnAbierto,btnCerrado,btnPunto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE){
            btnCeroo =findViewById(R.id.btnCeroo);
            btnAbierto = findViewById(R.id.btnAbierto);
            btnCerrado = findViewById(R.id.btnCerrado);
        ...
        lstNumeros.add( (Button) findViewById(R.id.btnCeroo));
        lstNumeros.add( (Button) findViewById(R.id.btnAbierto));
        lstNumeros.add( (Button) findViewById(R.id.btnCerrado));
